...
library (stringr);library (rstatix) # paquete para la funci?n get_summary_stats
...
###### preliminar analysis with seedr package #####
...
germination_summary %>%
  ...
  #geom_errorbar(aes(x= treatment, ymin = germination.lower, 
                    #ymax = germination.upper, color = aspect),width = 0.2, size =1.2)  +
  ...
  labs (title = "", y= "Mean Final Germination", x = "WP Treatment") 
